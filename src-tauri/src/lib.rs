   ...
   tauri::Builder::default()
       ...
       .plugin(tauri_plugin_process::init())
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            select_source_file,
            select_target_file,
            video_tasks::get_video_task_dashboard,
            video_tasks::open_video_learning_site,
            video_tasks::import_current_video_topic,
            video_tasks::sync_video_topic,
            video_tasks::open_video_topic,
            video_tasks::update_video_task_settings,
            video_tasks::start_video_queue,
            video_tasks::pause_video_queue,
            video_tasks::tick_video_queue,
            video_tasks::open_video_course,
            video_tasks::play_video_course,
